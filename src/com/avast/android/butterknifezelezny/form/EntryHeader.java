...
public class EntryHeader extends JPanel {
    ...
    public EntryHeader() {
        ...
        mAllCheck.setPreferredSize(new ResolutionDimension(40, 26));
        ...
        add(Box.createRigidArea(new ResolutionDimension(1, 0)));
        add(mAllCheck);
        add(Box.createRigidArea(new ResolutionDimension(11, 0)));
        add(mType);
        add(Box.createRigidArea(new ResolutionDimension(12, 0)));
        add(mID);
        add(Box.createRigidArea(new ResolutionDimension(12, 0)));
        add(mEvent);
        add(Box.createRigidArea(new ResolutionDimension(22, 0)));
        add(mName);
